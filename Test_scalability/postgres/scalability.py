...
execution_times = [112.41, 59.64, 38.79, 29.16, 22.39, 23.38, 23.92]
...
# 设置标题和标签
plt.title('Time taken for concurrent insert with different thread counts-PostgreSQL', fontsize=14)
...
# 文件保存路径为当前脚本所在目录
save_path = os.path.join(script_dir, 'scalability_postgres.png')
